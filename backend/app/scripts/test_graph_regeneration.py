...
Location: backend/app/scripts/test_graph_regeneration.py
Usage: python3 backend/app/scripts/test_graph_regeneration.py
"""
...
# Add project paths
# Script is in backend/app/scripts/, project root is 3 levels up
